...
- **WordDuel** ([wordduel.jiang-yi.xyz](https://wordduel.jiang-yi.xyz) · [GitHub](https://github.com/jiang-yi/WordDuel)) — Real-time multiplayer spelling game for students, aligned to the Australian Curriculum (Foundation–Year 12+). Practised as Product Owner: defined all requirements, game mechanics, scoring design, and development roadmap; entire codebase delivered by AI (Claude Code).
